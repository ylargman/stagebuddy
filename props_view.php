	...
	<div data-role="content">	      
		<form action="submit.php" method="post">
			<fieldset data-role="controlgroup" data-type="horizontal" class="localnav">
     		<a href="props_view.php?playID=<?php echo $_GET['playID']?>" data-role="button" class="ui-btn-active">
     		View</a>

     		<a href="props_edit.php?playID=<?php echo $_GET['playID']?>" data-role="button">
     		Edit</a>
			</fieldset>
		</form>
			...
			<div class="ui-grid-b">
				<div class="ui-block-a"><img src="bow-and-arrow.png"/><p></p><?php echo $name ?></div>
					<div class="ui-block-b">
						<?php
							$query_s_n="SELECT * FROM PropsScenes WHERE propID LIKE '{$propID}' AND playID=".$_GET['playID'];
