	...
	<div data-role="content">	      
    	...
    	<div class="ui-grid-a">
	    	...
	    	<div class="ui-block-b">
            	<div class="ui-grid-b">
	            	<div class="ui-block-a">
	            		<a href="#Prop_PopupA<?php echo $act?>S<?php echo $scene?>" data-rel="popup" data-transition="pop">
							<?php
								include("config.php");
						...
						<div data-role="popup" id="Prop_PopupA<?php echo $act?>S<?php echo $scene?>">
							<div data-role="collapsible-set" data-inset="true">
								<?php
					...
					<div class="ui-block-b" id="Element_Block">
						<a href="#Element_PopupA<?php echo $act?>S<?php echo $scene?>" data-rel="popup" data-transition="pop">
							<?php
								include("config.php");
						...
						<div data-role="popup" id="Element_PopupA<?php echo $act?>S<?php echo $scene?>">
							<div data-role="collapsible-set" data-inset="true">
								<?php
